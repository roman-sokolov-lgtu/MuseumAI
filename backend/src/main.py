...
async def ask_assistant(request: AskRequest, db: Session = Depends(database.get_db)):
    ...
    if is_first_message:
        ...
        system_prompt = (
            ...
            "- Если вопрос вообще не относится к данному экспонату, начни ответ с вежливого извинения и объясни, что ты можешь рассказать только об этом конкретном произведении.\n"
